...
export default function CheckoutPage() {
    ...
    const [infoData, setInfoData] = useState<InfoData>({
        ...
        fullAddress: userProfile?.lastFullAddress ?? '',
        ...
        const loadProfile = async () => {
            ...
            if (userProfile) {
                setInfoData((prev) => ({
                    ...
                    fullAddress: prev.fullAddress || userProfile.lastFullAddress || '',
                }));
                return;
            }
            ...
            try {
                ...
                if (profile) {
                    ...
                    setInfoData((prev) => ({
                        ...
                        fullAddress: prev.fullAddress || profile.lastFullAddress || '',
                    }));
    ...
    const handlePlaceOrder = async () => {
        ...
        try {
            ...
            const res = await fetch('/api/payment/create', {
                ...
                body: JSON.stringify({
                    ...
                    deliveryAddress: {
                        ...
                        fullAddress: infoData.fullAddress.trim(),
            ...
            upsertUserProfile(
                ...
                true,
                {},
                infoData.fullAddress.trim() // isPlacingOrder
                    ...
                    {step === 3 && (
                        <div>
                            ...
                            <div className="bg-white rounded-xl border border-gray-100 p-6 space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => setInfoData((p) => ({ ...p, roomNumber: e.target.value }))}
                                            placeholder="e.g. 102"
                                            className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-red-200 focus:border-red-400 transition"
                                        />
                                    </div>
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">
                                        Full Address <span className="text-gray-400 font-normal text-xs">(optional — helps delivery accuracy)</span>
                                    </label>
                                    <textarea
                                        value={infoData.fullAddress}
                                        onChange={(e) => setInfoData((p) => ({ ...p, fullAddress: e.target.value }))}
                                        rows={2}
                                ...
                                <div className="flex gap-3">
                                    {(['Delivery', 'Takeaway'] as const).map(type => (
                                        <button
                                            key={type}
                                            type="button"
                                            onClick={() => setInfoData((p) => ({ ...p, deliveryType: type }))}
                                            className={`flex-1 py-3 rounded-xl text-sm font-semibold border-2 transition-all ${infoData.deliveryType === type
                            ...
                            <div className="bg-white rounded-xl border border-gray-100 overflow-hidden">
                                <div className="p-6">
                                    ...
                                    <div className="mb-5 bg-gray-50 rounded-xl px-4 py-3 text-sm text-gray-600 border border-gray-100 space-y-1.5">
                                        ...
                                        {infoData.fullAddress && <p><span className="font-medium">Address:</span> {infoData.fullAddress}</p>}
