...
export async function POST(request: NextRequest) {
    try {
        ...
        if (vendorSnap.empty) {
            return NextResponse.json({ error: 'This email is not registered as a vendor.' }, { status: 403 });
        }
            ...
            html: `
                <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width: 480px; margin: 0 auto; padding: 40px 24px;">
                    <div style="text-align: center; margin-bottom: 32px;">
                        ...
                        <h1 style="margin: 0; font-size: 22px; font-weight: 800; color: #0f172a; letter-spacing: -0.5px;">Aroma Ops</h1>
                        <p style="margin: 4px 0 0; font-size: 13px; color: #94a3b8; font-weight: 600; text-transform: uppercase; letter-spacing: 1px;">Vendor Portal</p>
                    </div>

                    <h2 style="text-align: center; font-size: 20px; font-weight: 700; color: #0f172a; margin: 0 0 8px;">Your login code</h2>
                    <p style="text-align: center; font-size: 15px; color: #64748b; margin: 0 0 32px;">Enter this code to access your vendor dashboard.</p>
                    ...
                    <p style="text-align: center; font-size: 13px; color: #94a3b8; margin: 0 0 4px;">This code expires in <strong>5 minutes</strong>. Do not share it with anyone.</p>
