...
export const blogPosts: BlogPost[] = [
  {
    ...
    title: 'Best Late Night Food in IIM Mumbai: A Survival Guide',
    excerpt: 'Studying late at IIM Mumbai? Discover the top midnight snacks and meals that will keep you going through those intense case study sessions.',
    content: `
      <p>Life at IIM Mumbai is legendary for its intensity. Between case studies, group projects, and club activities, the day often stretches far into the night. And when the clock strikes midnight, the hunger pangs are real.</p>
      ...
      <p>At Aroma Dhaba, we've optimized our kitchen for the IIM Mumbai schedule. We know that 11 PM to 3 AM is when you need us most, and we're committed to delivering hot, hygienic food right to your hostel.</p>
    `,
    date: 'March 25, 2026',
    author: 'Aroma Team',
  ...
  },
  {
    ...
    title: 'How to Order Food in IIM Mumbai Campus: The Ultimate Convenience',
    excerpt: 'Ordering food at IIM Mumbai has never been easier. Learn how to use Aroma Dhaba\'s new platform for the fastest campus delivery.',
    content: `
      <p>With the launch of our new digital platform, ordering your favorite food at IIM Mumbai is now just a few clicks away. No more waiting on hold or dealing with busy phone lines.</p>
  ...
  },
  {
    ...
    title: 'Midnight Food Options in IIM Mumbai: Beyond the Usual',
    ...
    content: `
      <p>Midnight doesn't have to mean compromising on variety. At IIM Mumbai, the food scene is as diverse as the student body, and Aroma Dhaba is at the center of it.</p>
      ...
      <p>Aroma Dhaba is more than just a food outlet; it's a campus institution dedicated to serving the IIM Mumbai community. Next time you're hungry at 2 AM, remember we're just a click away.</p>
    `,
    date: 'March 15, 2026',
    author: 'Aroma Team',
    image: '/images/hero_food.png',
