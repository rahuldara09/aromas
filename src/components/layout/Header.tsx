...
import { Grid3X3, ShoppingCart, User, Search, X, Menu, LogOut } from 'lucide-react';
                        ...
                        <div className="px-6 pt-6 border-t border-gray-100">
                            ...
                            {isLoggedIn && (
                                <button
                                    ...
                                    className="mt-3 w-full flex items-center justify-center gap-2 border border-gray-200 text-gray-600 font-bold py-3 rounded-xl text-sm hover:bg-red-50 hover:text-red-600 hover:border-red-200 transition-all"
                                >
                                    <LogOut size={16} />
                                    Log out
                                </button>
