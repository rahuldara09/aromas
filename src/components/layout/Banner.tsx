...
export default function Banner() {
    ...
    return (
        <div className="bg-red-500 text-white text-center py-3 px-4 z-50">
            ...
            >
                <span className="shrink-0 flex items-center gap-1.5">🔥 <span className="whitespace-nowrap">Late Night Food</span> <span className="hidden min-[400px]:inline">at IIM Mumbai</span></span>
